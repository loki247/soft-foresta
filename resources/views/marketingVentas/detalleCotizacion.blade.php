...
@section('titulo')
    <title>ERP | Detalle Cotización</title>
@stop
@section('contenido')
    <br>
    <br>
    ...
    <div class="content-wrapper">
        <div class="col-md-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{route('marketingVentas.cotizaciones')}}">Cotizaciones</a></li>
                <li class="breadcrumb-item">Detalle Cotización</li>
            </ol>
            <button id="generarPDFCotización" class="btn btn-info text-light"><i class="fa fa-fw fa-file-pdf-o"></i>Exportar PDF</button>
